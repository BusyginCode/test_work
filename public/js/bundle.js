...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(_components.Main, null), document.getElementById('root'));
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(147)))
	  ...
	  function Main() {
	    ...
	    _this.closeModal = function () {
	      _this.setState({
	        ...
	        _utils.documentClick.unsubscribe(_this.closeModal);
	      });
	    };
	  ...
	  */
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      (0, _utils.ajax)('https://api.500px.com/v1/photos?feature=popular&consumer_key=wB4ozJxTijCwNuggJvPGtBGCRqaZVcF6jsrzUadF&page=' + this.state.step, '', function (data) {
	        _this2.setState({
	          photos: data.photos,
	    ...
	    */
	    ...
	    value: function openModal(photo) {
	      ...
	      this.setState({
	        ...
	        _utils.documentClick.subscribe(_this3.closeModal);
	      });
	    }
	    ...
	    */
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        { className: 'container' },
	        this.state.openPhoto ? React.createElement(
	          _reactModal2.default,
	          { isOpen: !!this.state.openPhoto, style: modalStyles },
	          React.createElement('img', { src: this.state.openPhoto.url }),
	          React.createElement(
	            'h5',
	            null,
	            this.state.openPhoto.description
	          ),
	          React.createElement(
	            'h3',
	            null,
	        ...
	        this.state.photos ? React.createElement(
	          'div',
	          ...
	          this.state.photos.map(function (photo, key) {
	            return React.createElement(
	              ...
	              React.createElement('img', {
	                src: photo.image_url,
	                onClick: _this4.openModal.bind(_this4, photo)
	              })
	            );
	          }),
	          ...
	          this.state.step > 1 ? React.createElement(
	            'button',
	            { className: 'btn btn-default', onClick: this.changeStep.bind(this, false) },
	            'Prev. page'
	          ) : null,
	
	          // check max step
	          this.state.step < this.state.totalPages ? React.createElement(
	            'button',
	            {
	          ...
	          'div',
	          { className: 'loader' },
	          React.createElement('img', { src: './images/loading.gif', style: { width: 200 + 'px' } })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.documentClick = exports.ajax = undefined;
	
	var _ajax2 = __webpack_require__(162);
	
	var _ajax3 = _interopRequireDefault(_ajax2);
	
	var _documentClick2 = __webpack_require__(163);
	
	var _documentClick3 = _interopRequireDefault(_documentClick2);
	...
	exports.documentClick = _documentClick3.default;
...
/***/ function(module, exports) {
	...
	exports.default = function (url, data, func) {
	  var method = arguments.length <= 3 || arguments[3] === undefined ? 'POST' : arguments[3];
	  var contentType = arguments[4];
	  ...
	  request.send((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && contentType !== false ? JSON.stringify(data) : data);
	};
...
/***/ function(module, exports) {
	...
	var DocumentClick = function () {
	  function DocumentClick() {
	    _classCallCheck(this, DocumentClick);
	
	    this.listeners = [];
	  }
	
	  _createClass(DocumentClick, [{
	    key: 'subscribe',
	    ...
	    value: function unsubscribe(listener) {
	      var key = this.listeners.indexOf(listener);
	      if (key >= 0) {
	...
	var documentClick = new DocumentClick();
	
	document.addEventListener('click', function (e) {
	
	  documentClick.listeners.forEach(function (listener) {
	    listener(e);
	  });
	}, false);
	
	exports.default = documentClick;
	module.exports = exports['default'];
